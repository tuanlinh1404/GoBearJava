...
public class TCGoBear {
	...
	public void GoBear() throws Exception {
		...
		webSupport.clickOnElement("//tbody//td[(text()='" + dateFrom + "' and @class!='old disabled day') and (text()='" + dateFrom + "' and @class!='new day') and (text()='" + dateFrom + "' and @class!='old day')]");
		webSupport.clickOnElement("//div[@class='date-to']");
		webSupport.clickOnElement("//tbody//td[(text()='" + dateTo + "' and @class!='old disabled day') and (text()='" + dateTo + "' and @class!='new day') and (text()='" + dateTo + "' and @class!='old day')]");
		...
		webSupport.dragAndDropElementByOffset("//label[contains(text(),'" + slider + "')]//following-sibling::div//div[@role='slider']", 50, 0);
		...
		webSupport.clickOnElement("//div[@class='date-from']");
		webSupport.clickOnElement("//tbody//td[(text()='" + detailDateFrom + "' and @class!='old disabled day') and (text()='" + detailDateFrom + "' and @class!='new day') and (text()='" + detailDateFrom + "' and @class!='old day')]");
		webSupport.clickOnElement("//div[@class='date-to']");
		webSupport.clickOnElement("//tbody//td[(text()='" + detailDateTo + "' and @class!='old disabled day') and (text()='" + detailDateTo + "' and @class!='new day') and (text()='" + detailDateTo + "' and @class!='old day')]");
